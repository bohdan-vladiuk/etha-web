...
export const PoliticianPanel: NextPage<Props> = (props) => {
    ...
    useEffect(() => {
        if (profileTag !== undefined && profileTag !== '' && _.isEmpty(user)) {
                    ...
                    <>
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="px-2 py-2">
                                    <h4 style={{ fontWeight: 'bolder' }}>
                                        {user.voteCount?.agree !== undefined ? user.voteCount?.agree : '...'}
                                    </h4>
                                    <h6>Agrees</h6>
                                </div>
                                <div className="px-2 py-2">
                                    <h4 style={{ fontWeight: 'bolder' }}>
                                        {user.voteCount?.disagree !== undefined ? user.voteCount?.disagree : '...'}
                                    </h4>
                                    <h6>Disagrees</h6>
                                </div>
                            </div>
                        ...
                        <InfiniteScroll
                            dataLength={
                                !_.isEmpty(state.postsData.content) ? Object.keys(state.postsData.content).length : 0
                            }
                            next={fetchMoreData}
