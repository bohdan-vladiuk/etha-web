...
export const TermsOfService: NextPage = () => {
    ...
    return (
        <div>
            ...
            >
                <p>OVERVIEW</p>
                <p>
                    This website is operated by Etha. Throughout the site, the terms &ldquo;we&rdquo;, &ldquo;us&rdquo;
                    and &ldquo;our&rdquo; refer to Etha. Etha offers this website, including all information, tools and
                ...
                <p>
                    In no case shall Etha, our directors, officers, employees, affiliates, agents, contractors, interns,
                ...
                <p>
                    You agree to indemnify, defend and hold harmless Etha and our parent, subsidiaries, affiliates,
                ...
                <p>
                    ...
                    by and construed in accordance with the laws of 1452 2nd Ave, Apt 6, New York, NY, 10021, United
                    States.
                </p>
                ...
                <p>
                    ...
                    <a href="mailto:nicole@etha.one">nicole@etha.one </a>
                </p>
            </Container>
            <hr />
        </div>
